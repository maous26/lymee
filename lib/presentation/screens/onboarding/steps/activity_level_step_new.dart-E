...
class ActivityLevelStep extends StatefulWidget {
  ...
  @override
  ActivityLevelStepState createState() => ActivityLevelStepState();
}
...
class ActivityLevelStepState extends State<ActivityLevelStep> {
  ...
  void _addSportActivity() {
    ...
    if (_useCustomSport) {
      ...
      sportName = _sportNameController.text.trim();
      ...
      sportName = selectedSport['name'] as String;
      intensity = selectedSport['intensity'] as SportIntensity;
    }
  ...
  Widget build(BuildContext context) {
    const currentAccentColor = LymDesignSystem.coral;
                              ...
                              children: _commonSports.map((sport) {
                                ...
                                return ChoiceChip(
                                  label: Row(
                                    ...
                                    children: [
                                      Icon(sport['icon'] as IconData, size: 16),
                          ...
                          Center(
                            child: ElevatedButton.icon(
                              ...
                              style: ElevatedButton.styleFrom(
                                ...
                                foregroundColor: LymDesignSystem.white,
                                padding: const EdgeInsets.symmetric(
                                    horizontal: LymDesignSystem.spacing20,
                                    vertical: LymDesignSystem.spacing12),
                                textStyle: LymDesignSystem.textTheme.labelLarge,
                              ),
                            ),
