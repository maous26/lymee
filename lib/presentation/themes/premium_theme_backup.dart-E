...
class PremiumTheme {
  ...
  // Helper methods to create system font TextStyles (replacing GoogleFonts)
  static TextStyle _poppinsTextStyle({
    ...
    return TextStyle(
      ...
      fontFamily:
          'SF Pro Display', // Use system font on iOS/macOS, fallback to default on other platforms
    );
  }

  static TextTheme _createPoppinsTextTheme(TextTheme baseTheme) {
    return baseTheme.copyWith(
      ...
      titleMedium: TextStyle(
        ...
        fontWeight: FontWeight.w600,
        letterSpacing: 0.1,
        color: baseTheme.titleMedium?.color,
      ),
      titleSmall: TextStyle(
        fontSize: 14,
        fontWeight: FontWeight.w500,
        letterSpacing: 0.1,
        color: baseTheme.titleSmall?.color,
      ),
      bodyLarge: TextStyle(
        fontSize: 16,
      ...
      labelLarge: TextStyle(
        ...
        fontWeight: FontWeight.w500,
        letterSpacing: 0.1,
        color: baseTheme.labelLarge?.color,
      ),
      labelMedium: TextStyle(
        fontSize: 12,
        fontWeight: FontWeight.w500,
        letterSpacing: 0.5,
        color: baseTheme.labelMedium?.color,
      ),
      labelSmall: TextStyle(
        fontSize: 10,
        fontWeight: FontWeight.w500,
        letterSpacing: 0.5,
        color: baseTheme.labelSmall?.color,
      ),
    );
  }
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    // Typographie
    textTheme: _createPoppinsTextTheme(
    ...
    appBarTheme: AppBarTheme(
      ...
      titleTextStyle: _poppinsTextStyle(
        fontSize: 18,
        fontWeight: FontWeight.w600,
        color: textDark,
      ),
    ...
    bottomNavigationBarTheme: BottomNavigationBarThemeData(
      ...
      selectedLabelStyle: _poppinsTextStyle(
        fontSize: 12,
        fontWeight: FontWeight.w500,
        color: primaryLight,
      ),
      unselectedLabelStyle: _poppinsTextStyle(
        fontSize: 12,
        fontWeight: FontWeight.w500,
        color: textMedium,
      ),
    ...
    outlinedButtonTheme: OutlinedButtonThemeData(
      style: ButtonStyle(
        foregroundColor: WidgetStateProperty.all<Color>(primaryLight),
        backgroundColor: WidgetStateProperty.all<Color>(Colors.transparent),
        side: WidgetStateProperty.all<BorderSide>(
          const BorderSide(color: primaryLight, width: 2),
        ),
        shape: WidgetStateProperty.all<RoundedRectangleBorder>(
          RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(borderRadiusMedium),
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      border: OutlineInputBorder(
        borderRadius: BorderRadius.circular(borderRadiusMedium),
        borderSide:
            BorderSide(color: textLight.withValues(alpha: 0.5), width: 1),
      ),
    ...
    checkboxTheme: CheckboxThemeData(
      ...
      side: BorderSide(color: textMedium.withValues(alpha: 0.5), width: 1.5),
      shape: RoundedRectangleBorder(
    ...
    radioTheme: RadioThemeData(
      fillColor: WidgetStateProperty.resolveWith<Color>((states) {
        ...
        return textMedium.withValues(alpha: 0.5);
      }),
    ),
    ...
    chipTheme: ChipThemeData(
      ...
      disabledColor: textLight.withValues(alpha: 0.1),
